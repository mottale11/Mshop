...
import { Trash2, Plus, Folder, FolderOpen } from 'lucide-react';
...
export default function CategoriesPage() {
    ...
    const [newItem, setNewItem] = useState({ name: '', slug: '', parent_id: '' });
    ...
    const handleAddCategory = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            setNewItem({ name: '', slug: '', parent_id: '' });
            fetchCategories();
        }
                ...
                <li key={node.id} style={{ marginBottom: '0.5rem' }}>
                    <div style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            {node.children && node.children.length > 0 ? <FolderOpen size={16} color="#f68b1e" /> : <Folder size={16} color="#9ca3af" />}
